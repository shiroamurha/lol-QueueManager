...
if get_champion_lock == 1:
    ...
    for i in range(1, 4):
        ...
        for i in range(0, len(id_champions_list)-1):
            try:
                id_champions_list[i]
            except:
                pass
    print (id_champions_list)

    championsPrio = []

    for i in range(0, len(id_champions_list)):
            try:
                championsPrio.append(id_champions_list[i])
            except:
                pass

    print(championsPrio)
elif get_champion_lock == 0:
...
championNames = {"Annie":"1","Olaf":"2","Galio":"3","Twisted Fate":"4","Xin Zhao":"5","Urgot":"6",
